...
-- Créer les menus pour les nouveaux groupes de permissions (IDEMPOTENT)
INSERT INTO menus (label, icon, route, component, parent_path, menu_group, sort_order, created_at, updated_at) VALUES
('People Management', 'people', '/people', 'people', '/people', 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Users Management', 'users', '/users', 'users', '/users', 1, 2, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Roles Management', 'shield', '/roles', 'roles', '/roles', 1, 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Permissions Management', 'key', '/permissions', 'permissions', '/permissions', 1, 4, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Menus Management', 'menu', '/menus', 'menus', '/menus', 1, 5, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Sessions Management', 'session', '/sessions', 'sessions', '/sessions', 1, 6, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Authorizations Management', 'lock', '/authorizations', 'authorizations', '/authorizations', 1, 7, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('Auth Management', 'auth', '/auth', '/auth', '/auth', 1, 8, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('System Management', 'settings', '/system', '/system', '/system', 1, 9, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
